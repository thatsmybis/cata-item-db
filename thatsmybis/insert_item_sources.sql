...
INSERT INTO `item_sources` (`name`, `slug`, `instance_id`, `npc_id`, `object_id`, `order`, `created_at`)
    ...
    ("Omnotron",  "omnotron",  52, null,  null, 3, "2024-04-07 00:00:00"), -- 42166, 42179, 42178, 42180
    ...
    -- Firelands Normal
    ("Trash",              "trash",              55, 53691, null, 1, "2024-04-07 00:00:00"),
    ("Shannox",            "shannox",            55, 53691, null, 2, "2024-04-07 00:00:00"),
    ("Lord Rhyolith",      "lord-rhyolith",      55, 52558, null, 3, "2024-04-07 00:00:00"),
    ("Beth'tilac",         "bethtilac",          55, 52498, null, 4, "2024-04-07 00:00:00"),
    ("Alysrazor",          "alysrazor",          55, 52530, null, 5, "2024-04-07 00:00:00"),
    ("Baleroc",            "baleroc",            55, 53494, null, 6, "2024-04-07 00:00:00"),
    ("Majordomo Staghelm", "majordomo-staghelm", 55, 52571, null, 7, "2024-04-07 00:00:00"),
    ("Ragnaros",           "ragnaros",           55, 52409, null, 8, "2024-04-07 00:00:00"),
    -- Firelands Heroic
    ("Trash",              "trash",              56, 53691, null, 1, "2024-04-07 00:00:00"),
    ("Shannox",            "shannox",            56, 53691, null, 2, "2024-04-07 00:00:00"),
    ("Lord Rhyolith",      "lord-rhyolith",      56, 52558, null, 3, "2024-04-07 00:00:00"),
    ("Beth'tilac",         "bethtilac",          56, 52498, null, 4, "2024-04-07 00:00:00"),
    ("Alysrazor",          "alysrazor",          56, 52530, null, 5, "2024-04-07 00:00:00"),
    ("Baleroc",            "baleroc",            56, 53494, null, 6, "2024-04-07 00:00:00"),
    ("Majordomo Staghelm", "majordomo-staghelm", 56, 52571, null, 7, "2024-04-07 00:00:00"),
    ("Ragnaros",           "ragnaros",           56, 52409, null, 8, "2024-04-07 00:00:00"),
    -- Dragon Soul Normal
    ("Trash",                "trash",                57, null, null, 1, "2024-04-07 00:00:00"),
    ("Morchok",              "morchok",              57, null, null, 2, "2024-04-07 00:00:00"),
    ("Warlord Zon'ozz",      "warlord-zon-ozz",      57, null, null, 3, "2024-04-07 00:00:00"),
    ("Yor'sahj",             "yor-sahj",             57, null, null, 4, "2024-04-07 00:00:00"),
    ("Hagara",               "hagara",               57, null, null, 5, "2024-04-07 00:00:00"),
    ("Ultraxion",            "ultraxion",            57, null, null, 6, "2024-04-07 00:00:00"),
    ("Warmaster Blackhorn",  "warmaster-blackhorn",  57, null, null, 7, "2024-04-07 00:00:00"),
    ("Spine of Deathwing",   "spine-of-deathwing",   57, null, null, 8, "2024-04-07 00:00:00"),
    ("Madness of Deathwing", "madness-of-deathwing", 57, null, null, 9, "2024-04-07 00:00:00"),
    -- Dragon Soul Heroic
    ("Trash",                "trash",                58, null, null, 1, "2024-04-07 00:00:00"),
    ("Morchok",              "morchok",              58, null, null, 2, "2024-04-07 00:00:00"),
    ("Warlord Zon'ozz",      "warlord-zon-ozz",      58, null, null, 3, "2024-04-07 00:00:00"),
    ("Yor'sahj",             "yor-sahj",             58, null, null, 4, "2024-04-07 00:00:00"),
    ("Hagara",               "hagara",               58, null, null, 5, "2024-04-07 00:00:00"),
    ("Ultraxion",            "ultraxion",            58, null, null, 6, "2024-04-07 00:00:00"),
    ("Warmaster Blackhorn",  "warmaster-blackhorn",  58, null, null, 7, "2024-04-07 00:00:00"),
    ("Spine of Deathwing",   "spine-of-deathwing",   58, null, null, 8, "2024-04-07 00:00:00"),
    ("Madness of Deathwing", "madness-of-deathwing", 58, null, null, 9, "2024-04-07 00:00:00");
